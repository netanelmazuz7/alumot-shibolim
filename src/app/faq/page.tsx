    ...
    items: [
      {
        ...
        a: "אלומת שיבולים פועלת כפלטפורמה לעזרה הדדית בין חברי קהילה - מודל שנקרא P2P Protection. אנחנו לא מוכרים פוליסות ביטוח, לא גובים פרמיות, ולא משווקים מוצר ביטוח. במקום זה, חברי הקהילה בוחרים להתחייב לעזור אחד לשני באירועי נזק לרכב. המודל הזה פועל בהצלחה במדינות מתקדמות בעולם ואנחנו מתנהלים בהתאם לחוקי הצרכנות והגנת הפרטיות בישראל.",
      },
      {
