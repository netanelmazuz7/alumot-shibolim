...
export const metadata = {
  title: "מי אנחנו - אלומת שיבולים",
  description:
    "הסיפור מאחורי אלומת שיבולים - קהילת ההגנה ההדדית הראשונה בישראל לרכב.",
};
      ...
      <section className="pt-32 pb-16 bg-gradient-to-bl from-primary via-primary-dark to-primary relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-white mb-5 leading-tight">
            כוחה של קהילה איכותית
          </h1>
          <p className="text-xl text-white/70 max-w-2xl mx-auto leading-relaxed">
            אנחנו לא עוד חברת הייטק. אנחנו קבוצה של אנשים שהבינו דבר פשוט -
            כשמתחברים לקהילה איכותית של אנשים אחראיים, אפשר לחסוך המון כסף ולחיות בראש שקט.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl shadow-xl p-10 md:p-14 border border-wheat-dark/10">
            ...
            <div className="prose prose-lg max-w-none text-primary/70 leading-relaxed space-y-5">
              <p>
                הסיפור של אלומת שיבולים מתחיל מתובנה פשוטה: <strong className="text-primary">
                כשאתה מחובר לקהילה איכותית של אנשים אחראיים, אתה חוסך הרבה כסף</strong>.
                זה לא רעיון חדש - זה רעיון עתיק כמו עם ישראל עצמו, שמצא את הדרך שלו
                לשגשג לאורך הדורות דווקא בזכות ערבות הדדית ושיתוף פעולה קהילתי.
              </p>
              <p>
                הסתכלנו מסביב וראינו את זה קורה בעשרות תחומים בישראל של היום:
              </p>
              <ul className="list-disc pr-6 space-y-2">
                <li>
                  <strong>קיבוצים ומושבים</strong> - קהילות שמתחלקות במשאבים,
                  בציוד חקלאי ובעלויות, וחוסכות עשרות אחוזים מול עבודה בנפרד.
                </li>
                <li>
                  <strong>קבוצות רכישה</strong> בשכונות ובוואטסאפ - קונים מוצרי חשמל,
                  רהיטים ומזון ישירות מהיבואן ומשיגים הנחות של 30-50%.
                </li>
                <li>
                  <strong>קהילות פרילנסרים והייטק</strong> - חולקים משרדים, כלים,
                  ביטוחי בריאות קבוצתיים ומשא ומתן משותף עם ספקים.
                </li>
                <li>
                  <strong>חברי מקצוע</strong> (רופאים, עורכי דין, מורים) שמתארגנים
                  ומקבלים הטבות בנקאיות, ברכב ובמשכנתאות שאדם בודד לא יכול לקבל.
                </li>
                <li>
                  <strong>קהילות דתיות וקהילות שכונתיות</strong> - גמ&quot;חים, קרנות סיוע,
                  ואפילו מערכות ערבות הדדית לא פורמליות בין שכנים.
                </li>
                <li>
                  <strong>מועדוני צרכנות</strong> כמו שופרסל Good, חברות האשראי
                  והקופות הגדולות - כולן מבוססות על עקרון אחד: כוח קנייה קבוצתי.
                </li>
              </ul>
              <p>
                שאלנו את עצמנו - למה הרעיון הזה לא הגיע לתחום הרכב? למה כל נהג
                אחראי בישראל משלם לבד, במקום להתחבר לקהילה של נהגים אחראיים כמוהו,
                ולחסוך יחד?
              </p>
              <p>
                אחרי שנתיים של מחקר, בניית מודל משפטי כשר, ופיתוח טכנולוגי -
                אלומת שיבולים נולדה. לא כחברת ביטוח. כקהילה של נהגים אחראיים
                שבוחרים לעזור זה לזה, בשקיפות מלאה וללא מתווכים.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                name: "נתנאל מזוז",
                role: "מייסד ומנכ״ל",
                bio: "יזם ישראלי שמאמין בכוחה של קהילה. הוביל את החזון של אלומת שיבולים מיום אחד - פלטפורמה שמחזירה את הכוח לאנשים ואת הכסף לכיס שלהם.",
              },
              {
                name: "דנה לוי",
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { num: "73%", label: "חיסכון ממוצע לחבר" },
